...
const translations = {
  en: {
    ...
    "patterns.text5": "Existing accounts are not growing because there is no repeatable upsell or expansion motion.",
  ...
  es: {
    ...
    "patterns.text5": "Las cuentas actuales no están creciendo porque no existe un motion repetible de upsell o expansión.",
    ...
    "testimonials.quote1": "\"Jorge Téllez delivers an exceptional mentoring skillset. His mentorship has been impactful across growth, branding, capital raising, and strategic execution.\"",
    ...
    "testimonials.quote3": "\"He has consistently made himself available to provide guidance and support, giving above and beyond to help us navigate startup challenges.\"",
